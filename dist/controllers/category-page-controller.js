...
exports.getCategoryPageDataFiltered = exports.getCategoryPageData = void 0;
...
const getCategoryPageDataFiltered = async (req, res) => {
    try {
        const { cityId, categoryId } = req.params;
        ...
        const convex = convex_service_1.convexService.getClient();
        const pageData = await convex.query(api_1.api.experienceFunctions.getCategoryPageDataFiltered, {
            cityId: cityId,
            categoryId: categoryId,
            sortBy: sortBy,
            subcategoryNames: parsedSubcategoryNames
        });
        // Collect all experiences from the filtered response
        const allExperiences = [
...
exports.getCategoryPageDataFiltered = getCategoryPageDataFiltered;
