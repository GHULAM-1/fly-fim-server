...
export declare const createSubcategory: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const updateSubcategory: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
