...
router.post('/signin', async (req, res) => {
    try {
        ...
        await convex_service_1.convexService.mutation('userFunctions:createSession', {
            userId,
            sessionToken,
            expires,
        });
...
router.post('/signout', auth_middleware_1.authMiddleware, async (req, res) => {
    try {
        if (req.sessionToken) {
            await convex_service_1.convexService.mutation('userFunctions:deleteSession', {
...
router.get('/session/cleanup', async (req, res) => {
    try {
        const deletedCount = await convex_service_1.convexService.mutation('userFunctions:cleanupExpiredSessions', {});
        res.json({
            success: true,
